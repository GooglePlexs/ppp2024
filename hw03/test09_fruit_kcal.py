def calculate_calories(calories, eat_orange, eat_strawberry, eat_banana):

  for fruit, fruit_calories in calories.items():
    if fruit == "한라봉":
      total_calories_hallabong = fruit_calories * eat_orange 
    elif fruit == "딸기":
...
eat_orange = int(input("섭취한 한라봉의 양을 기입하시오(100g 단위)"))
